  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
		$text = $event['message']['text'];
	   	...
	   	else if($text == "ชื่อผู้พัฒนาระบบ" || $text == "ชื่อผู้พัฒนา" || $text == "ผู้พัฒนาระบบ" || $text == "ผู้พัฒนา" || $text == "ชื่อผู้พัฒนาระบบคือใคร"|| $text == "ชื่อผู้พัฒนาคือใคร"|| $text == "ผู้พัฒนาระบบคื่อใคร"|| $text == "ผู้พัฒนาคือใคร"){
			$reply_message = 'ชื่อผู้พัฒนา คือ นางสาวหทัยกาญจน์ หิรัญนาค';
		}
